...
firebase_spec = importlib.util.find_spec("firebase_admin")
if firebase_spec is not None:
    ...
    print("Error: firebase_admin package is not installed. Install with pip install firebase-admin")
